...
void stereo_MSGM_MYPro(Mat &left,Mat &right,Mat &dis,int maxdis,int P1,int P2,int iter){
    if(left.size()!=right.size())
        return;
    Size size = left.size();
...
//            stereo_MSGM_FW_AW(leftmat,rightmat,dis,20,15,800,32*100,1,0);
            stereo_MSGM_MYPro(leftmat,rightmat,dis,20,20,80,100);
//            stereo_MSGM_FW_AW(leftmat,rightmat,dis,20,6,8,32,0,0);
